    ...
    stages: [
      {
        ...
        label: 'STAGE_01',
        title: 'INTEL GATHER',
        prompt: 'Target is Sable Corp\'s Head of Internal Security. Runs a sixteen-person detail, rotates routes daily. You need their schedule for the next forty-eight hours before you can plan an approach.',
        choices: [
          {
            id: 'lq_hack',
