...
export const FACTION_CONTRACTS = [
  // ── LEXICON — gene-edit heist ──────────────────────────────────────────────
  {
    ...
    successNarration: 'The Lexicon receives the work. "Meaning belongs to those who can read it," Kade quotes. Payment clears.',
    ...
    stages: [
      {
        ...
        prompt: 'The rogue contractor holes up in a dead mall in Sector 9. Grammaton wants it clean and by-the-book. Announce yourself as sanctioned enforcement (FACE) or move in quiet.',
        choices: [
          {
            id: 'gr_announce',
  ...
  // ── SIGNAL — own the pipes ─────────────────────────────────────────────────
  {
    ...
    successNarration: 'The relay sings again. The Signal sees its pipe restored and remembers who fixed it.',
    ...
    stages: [
      {
        ...
        prompt: 'The model runs on a sealed quant cluster behind a trading floor that never sleeps. You can socially-engineer a floor pass, or ride in on the catering contractor\'s creds.',
        choices: [
          {
            id: 'rf_pass',
    ...
    stages: [
      {
        ...
        prompt: 'A Grammaton checkpoint stands between you and the canal. Slip the crate through hidden in a refuse hauler, or bribe the bored officer working the late shift (200 CR).',
        choices: [
          {
            id: 'ut_bribe',
    ...
    stages: [
      {
        ...
        prompt: 'The Lexicon node broadcasts from a repurposed cathedral spire, all stained glass and server racks. Climb the exterior in the rain (GRIT), or bluff past the acolytes guarding the door (FACE).',
        choices: [
          {
            id: 'st_climb',
  ...
  // ── UNDERTOW — high-trust deep job (ALLIED-gated) ──────────────────────────
  {
    ...
    stages: [
      {
        ...
        prompt: 'Grammaton moves on the ledger\'s holder at dawn. You have hours. Hit the safehouse ahead of them in the dark (GHOST), or intercept the holder in transit and take it on the move.',
        choices: [
          {
            id: 'um_safehouse',
    ...
    successNarration: 'The ledger is Undertow\'s, the underworld stays opaque, and your name is spoken in the gray with something like reverence.',
    ...
    stages: [
      {
        ...
        prompt: 'Three trader haunts, three whispers, one lie. Sell it with conviction in person (FACE), or inject it as forged insider chatter into the exchange feeds (WIRE).',
        choices: [
          {
            id: 'rf2_talk',
