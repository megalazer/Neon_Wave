export const MID_CONTRACTS = [
  {
    ...
    questlineStage: 1,
    cyberwareReward: { pool: 'MID', chance: 0.5 },
    name: 'VAULT_BREACH',
    ...
    successNarration: 'Vault contents delivered. Kade\'s buyer pays immediately. Full transfer plus a bonus for the clean exit. Kade\'s first piece. Three more jobs in the chain and the boardroom cracks open.',
    ...
    stages: [
      {
        ...
        prompt: 'Kade calls — the Vault Breach intel opened doors. Now leverage them. Target runs his personal comms through an encrypted private server. His assistant is the weak link. You need an in; talk your way close, or spoof a corporate identity to get access.',
        choices: [
          {
            id: 'bo_charm',
    ...
    stages: [
      {
        ...
        label: 'STAGE_01',
        title: 'LOCATE ASSET',
        prompt: 'Third op in Kade\'s chain. Helix exec needs extraction before Grammaton security finds him. The analyst, codename VESPER, is holed up somewhere in the Industrial District. She\'s gone dark on her primary comm. You can try to triangulate her emergency beacon, or work your contacts.',
        choices: [
          {
            id: 'ae_beacon',
...

  {
    ...
    successNarration: 'Depot is ash. Pyre confirms structural collapse. Full transfer with a voice note: "Now that\'s how you do it." Pyre pays in full. No chain, no loyalty — just fire and credits.',
