export const FLAVOR_EVENTS = [
  {
    ...
    type: 'flavor',
    weight: 8,
    narration: 'Acid rain falls on the Saltgate strip. Neon signs flicker. The city breathes wet and electric.',
    effects: {},
    accent: 'outline',
  },
  {
  ...
  },
  {
    ...
    type: 'flavor',
    weight: 3,
    narration: 'An ad for a new sensestream plays on loop: EXPERIENCE GENUINE HAPPINESS. NO RECURRING FEES FOR THE FIRST MONTH. The fine print scrolls too fast. You already know it says "subscription auto-renews."',
    effects: {},
    accent: 'primary',
  },
  ...
  },
  {
    ...
    narration: 'Saltgate Market is alive at this hour. Three separate hustles unfold within earshot. You could join any of them. You read the angles without trying.',
    effects: {},
    accent: 'outline',
  },
  {
  ...
  // ── Reactive flavor events ─────────────────────────────────────────────────────
  {
    id: 'flv_rich_runner_problem',
    type: 'flavor', weight: 5,
    triggers: { minCredits: 5000 },
    narration: 'A wealth-management bot pings your account, offering "discrete portfolio diversification." In Night City, that means guns, chrome, or both.',
    effects: {},
    accent: 'tertiary',
  },
  {
    id: 'flv_cyber_misfire',
    type: 'flavor', weight: 6,
    triggers: { lowHumanity: true },
    narration: 'Your optics flicker into thermal for half a second. The world goes blue-red, then normal. You didn\'t trigger that. You never do.',
    effects: { morale: -3 },
    accent: 'error',
  },
  {
    id: 'flv_chrome_phantom',
    type: 'flavor', weight: 4,
    triggers: { lowHumanity: true },
    narration: 'You feel a hand on your shoulder. Nobody\'s there. The chrome remembers sensations the flesh never had. The chrome doesn\'t always remember correctly.',
    effects: {},
    accent: 'outline',
  },
  {
    id: 'flv_landlord_blues',
    type: 'flavor', weight: 5,
    triggers: { requiresRealEstate: true },
    narration: 'One of your properties flashes a maintenance alert. Pipe leak in Unit 3. You approve the repair remotely. Being a landlord in Night City is just another kind of hustle.',
    effects: { credits: -50 },
    accent: 'secondary',
  },
  {
    id: 'flv_property_portfolio',
    type: 'flavor', weight: 4,
    triggers: { requiresRealEstate: true },
    narration: 'You cross-check your holdings against the latest district valuations. Up three percent. In this economy, that\'s practically a miracle.',
    effects: {},
    accent: 'primary',
  },
  {
    id: 'flv_garage_check',
    type: 'flavor', weight: 4,
    triggers: { requiresVehicle: true },
    narration: 'You run a diagnostic on your vehicle. Engine\'s solid. Fuel cell at 80%. Someone left a scratch on the rear panel. You make a note.',
    effects: {},
    accent: 'tertiary',
  },
  {
    id: 'flv_ride_ready',
    type: 'flavor', weight: 3,
    triggers: { requiresVehicle: true },
    narration: 'A street kid stops to admire your ride. "Preem wheels, choom." You nod. The city respects horsepower. Always has.',
    effects: { morale: 3 },
    accent: 'outline',
  },
];
